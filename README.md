General recommendations to keep code structured and clean, so that other users can benefit from readability and to facilitate collaboration.

# Project structuring
---
Based on the guidelines recommended by the [Hitchhiker's Guide to Data Science for Social Good](https://github.com/dssg/hitchhikers-guide/tree/master/sources/curriculum/0_before_you_start/pipelines-and-project-workflow).

An example folder structure for a (medium) Python project would be as follows:
```
├── LICENSE
